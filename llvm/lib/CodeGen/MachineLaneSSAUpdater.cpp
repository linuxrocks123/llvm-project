...
MachineLaneSSAUpdater::insertLaneAwarePHI(Register OrigVReg, LaneBitmask DefMask) {
  ...
  // PHI-def VNInfo, so they correctly get no PHI. Operands are resolved from the
  // frozen reaching oracle (placeholder-then-patch).
